...
// function logBookSummaries() {
//     bookCollection.forEach((book) => {
//         console.log(`${book.title} Por ${book.author} (${book.publicationYear})`);
//     });
// }

// console.log(logBookSummaries())
...
//             if (rating.source === "Goodreads" && rating.score > maxScore) {
...
// console.log(findHighestRatedBook());
