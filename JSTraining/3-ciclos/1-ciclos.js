...
// Primero hay un variable "const" declarada como "saludo" e inicializada con un string
// Luego hay otra variable tipo "let" declarada como "saludoParseado" e inicializada con un string

/* Luego hay un ciclo for, que dentro de este tiene una variable tipo let declarada como "index" que inicializa en 0; luego pasa

a la condicion que nos indica que, si la variable index es menor a la longitud de la variable saludo; pasará a las post operacion para iterar
Luego tenemos un condicional el cual indica que, si saludo con la indexación sea igual a espacio en blanco va a pasar a saludoParseado y le va agregar a ese espacio en blanco un "_"

luego si esto no se cumple, hará que el saludoParseado se junte con el saludo[index]

Y por último imprime el saludoParseado
*/
