...
/*
Using the bookCollection array, write a function that checks rating consistency.
Rules:
1. A book is considered consistent if the absolute difference between:
Goodreads score - Amazon score is less than or equal to 0.5.
2. The function must:
Count how many books are consistent
Count how many books are inconsistent
3. Return an object like:
{
  consistent: X,
  inconsistent: Y
}
Hint: Absolute difference, Business-rule validation, Binary classification

*/


function valuesBooks(bookCollection) {
    ...
    for (let i = 0; i < bookCollection.length; i++) {
        ...
        let puntaje1 = bookCollection[i].ratings[0].score;
        let puntaje2 = bookCollection[i].ratings[1].score;


        let diferencia = Math.abs(puntaje1 - puntaje2)
...
console.log(valuesBooks(bookCollection));